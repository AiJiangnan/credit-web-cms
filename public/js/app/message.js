...
layui.define(["jquery"], function (i) {
    var s = layui.jquery, e = (s(document), s("body")), a = {
        v: "1.0.0", times: 1, _message: function () {
            ...
            var e = this, a = e._message(), t = e.times, n = void 0 === (i = i || {}).skin ? "default" : i.skin, d = void 0 === i.msg ? "请输入一些提示信息!" : i.msg, m = void 0 === i.autoClose || i.autoClose,
    ...
    layui.link("/css/main/app/message.css"), i("message", a)
});