layui.use(['table', 'laydate'], () => {
    ...
    t.render({
        ...
        cols: [[
            ...
            {field: 'applyNum', title: '申请编号', align: 'center', width: 120, templet: d => `<a target="_blank" href="/approve/detail.html?applyId=${d.id}&userId=${d.userId}&applyNo=${d.applyNum}&channel=${d.channel}&from=1">${d.applyNum}</a>`},
