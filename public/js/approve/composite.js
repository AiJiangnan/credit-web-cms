layui.use(['table', 'laydate'], () => {
    ...
    let columsData = {
        ...
        applyNum: {field: 'applyNum', title: '申请编号', align: 'center', width: 240, templet: d => `<a href="/approve/detail.html?applyId=${d.id}&userId=${d.userId}&applyNo=${d.applyNum}&from=0">${d.applyNum}</a>`},
