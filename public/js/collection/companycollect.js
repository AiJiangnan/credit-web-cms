layui.use(['table', 'laydate'], () => {
    ...
    t.render({
        ...
        cols: [[
            ...
            {field: 'applyNo', title: '申请编号', align: 'center', width: 260, templet: d => `<a href="/collection/detail.html?applyId=${d.applyId}&userId=${d.userId}&applyNo=${d.applyNo}&channel=${d.sdChannel}&from=0">${d.applyNo}</a>`},
