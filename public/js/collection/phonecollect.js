layui.use(['table', 'laydate'], () => {
    ...
    t.render({
        ...
        cols: [[
            ...
            {field: 'applyNo', title: '申请编号', align: 'center', width: 120, templet: d => `<a target="_blank" href="/collection/detail.html?applyId=${d.applyId}&userId=${d.userId}&applyNo=${d.applyNo}&channel=${d.sdChannel}&from=1">${d.applyNo}</a>`},
    ...
    f.on('submit(submit)', d => {
        t.reload('phonecollect', {page: {curr: 1}, where: d.field});
        return false;
    });
